...
<tr> 
 ...
 <tr>
  ...
  <td><jsp:getProperty property="establishyear" name="upbean"/>년</td>
  <td>상시종업원수</td>
  <td colspan ="2"><jsp:getProperty property="workernum" name="upbean"/>명</td
  ><td>연구개발인력수</td>
  <td colspan ="2"><jsp:getProperty property="researchernum" name="upbean"/>명</td>
 </tr>
 <tr>
 ...
 <tr>
  <td colspan ="2"><jsp:getProperty property="totalmoney" name="upbean"/>백만원</td>
  <td colspan ="2"><jsp:getProperty property="exportmoney" name="upbean"/>백만원</td>
  <td colspan ="2"><jsp:getProperty property="income" name="upbean"/>백만원</td>
  <td colspan ="3"><jsp:getProperty property="developmentmoney" name="upbean"/>백만원</td>
 </tr>
 ...
 <tr>
  <td >보유기술현황</td>
  <td>특허출원</td>
  <td><jsp:getProperty property="patent" name="upbean"/>건</td>
  <td>특허등록</td>
  <td><jsp:getProperty property="patentregister" name="upbean"/>건</td>
  <td>실용신안</td>
  <td><jsp:getProperty property="utilitymodel" name="upbean"/>건</td>
  <td>미출원기술</td>
  <td><jsp:getProperty property="nonpatent" name="upbean"/>건</td>
 <tr>
 <tr>
  <td colspan ="2">기술유출관련소송경험</td>
  <td colspan ="7">최근3년간  <jsp:getProperty property="lawsuit" name="upbean"/>건</td>
 </tr>
</table>
